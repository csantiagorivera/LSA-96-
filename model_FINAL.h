...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x23, 0x41, 0xbb, 0x6a, 0xb5, 0x4c, 0x6c, 0x4c, 0x84, 0x54, 0xca, 0xd7, 0xf1, 0x30, 0xa2, 0x93}
...
// data_out [10] (40 bytes)
#define IMAI_DATA_OUT_RANK (1)
#define IMAI_DATA_OUT_SHAPE ((int[]){10})
#define IMAI_DATA_OUT_COUNT (10)
#define IMAI_DATA_OUT_BYTES (40)
#define IMAI_DATA_OUT_TYPE float
#define IMAI_DATA_OUT_TYPE_ID IMAGINET_TYPES_FLOAT32
#define IMAI_DATA_OUT_SHIFT 0
#define IMAI_DATA_OUT_OFFSET 0
#define IMAI_DATA_OUT_SCALE 0
#define IMAI_DATA_OUT_SYMBOLS {"unlabeled", "Back_Left", "Back", "Back_Right", "Front_Left", "Front", "Front_Right", "Left", "Noise", "Right"}
